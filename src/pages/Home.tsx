...
const Home = () => {
    return (
        <div className=" flex-1 flex items-center justify-center">
            <div className="flex lg:px-10  h-full lg:flex-row flex-col  items-center lg:space-y-0 space-y-10 lg:gap-16 justify-center">
                {/* Profile Image  */}
                <div className="rounded-full relative overflow-hidden md:w-70 md:h-70 w-55 h-55 ">
                    <img className=" w-full h-full object-cover" src={profileImg} alt="" />
                    <div className="absolute top-0  w-full h-full border-8 rounded-full border-[#555555]/50">
                    </div>
                </div>
